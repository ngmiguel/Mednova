...
class DemoCatalog {
  ...
  static const appointments = [
    AppointmentModel(
      ...
      notes: 'Apporter les résultats d\'analyses sanguines.',
      durationMinutes: 30,
    ...
    AppointmentModel(
      ...
      patientId: 'pat-002',
      doctorId: 'doc-001',
      patientUserId: 'user-patient-2',
      doctorUserId: 'user-doctor',
      scheduledAt: '2026-06-29T14:30:00Z',
      status: 'SCHEDULED',
      reason: 'Suivi post-opératoire',
      notes: 'Contrôle cicatrisation — salle 3B.',
      durationMinutes: 45,
    ...
    AppointmentModel(
      ...
      doctorId: 'doc-003',
      patientUserId: 'user-patient',
      doctorUserId: 'user-doctor-3',
      scheduledAt: '2026-06-25T11:00:00Z',
      status: 'COMPLETED',
      reason: 'Bilan annuel',
      durationMinutes: 30,
      createdAt: '2026-06-01T08:00:00Z',
      updatedAt: '2026-06-25T11:35:00Z',
    ),
  ];
  ...
  static const auditEvents = [
    AuditEventModel(
      ...
      summary: 'Connexion réussie — admin@mednova.ai (2FA validée)',
      payload: '{"userId":"user-admin","email":"admin@mednova.ai","ip":"192.168.1.10"}',
    ),
    AuditEventModel(
      eventId: 'evt-002',
      ...
      actorLabel: 'Système IA (automatique)',
      summary: 'Alerte HIGH — patient Marie Dupont (score 72) après enregistrement constantes',
      payload: '{"patientId":"pat-001","riskScore":72,"riskLevel":"HIGH","triggerEventType":"VITALS_RECORDED"}',
    ),
    AuditEventModel(
      eventId: 'evt-003',
      ...
      actorLabel: 'Emma Wilson (Infirmière)',
      summary: 'Création dossier patient Sophie Laurent',
      payload: '{"patientId":"pat-003","createdBy":"user-nurse","email":"sophie.l@email.com"}',
    ),
    AuditEventModel(
      eventId: 'evt-004',
      eventType: 'APPOINTMENT_SCHEDULED',
      source: 'appointment-service',
      receivedAt: '2026-06-26T16:00:00Z',
      correlationId: 'corr-appt-004',
      actorLabel: 'Alice Admin',
      summary: 'RDV planifié — Marie Dupont ↔ Dr. John Smith le 28/06',
      payload: '{"appointmentId":"appt-001","patientId":"pat-001","doctorId":"doc-001","status":"CONFIRMED"}',
    ),
  ];
  ...
  static const riskAssessments = {
    'pat-001': [
      RiskAssessmentModel(
        ...
        triggerEventType: 'VITALS_RECORDED',
        correlationId: 'corr-ai-002',
      ),
      RiskAssessmentModel(
        id: 'risk-002',
