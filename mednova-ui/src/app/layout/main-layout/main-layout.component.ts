...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, RouterLink, RouterLinkActive, AppIconComponent, TranslatePipe],
...
export class MainLayoutComponent implements OnInit {
  ...
  readonly mainNav: NavItem[] = [
    ...
    { path: '/patients', labelKey: 'nav.patients', icon: 'patients', countKey: 'patients', roles: ['ROLE_ADMIN', 'ROLE_DOCTOR', 'ROLE_NURSE', 'ROLE_AUDITOR'] },
    { path: '/doctors', labelKey: 'nav.doctors', icon: 'doctors', countKey: 'doctors', roles: ['ROLE_ADMIN', 'ROLE_DOCTOR', 'ROLE_NURSE', 'ROLE_AUDITOR'] },
    { path: '/appointments', labelKey: 'nav.appointments', icon: 'appointments', countKey: 'appointments' },
    { path: '/messaging', labelKey: 'nav.messaging', icon: 'messages', roles: ['ROLE_DOCTOR', 'ROLE_PATIENT'] },
    { path: '/ai', labelKey: 'nav.ai', icon: 'ai' },
    { path: '/notifications', labelKey: 'nav.notifications', icon: 'notifications', badgeKey: 'notifications' },
    { path: '/audit', labelKey: 'nav.audit', icon: 'audit', countKey: 'auditEvents', roles: ['ROLE_ADMIN', 'ROLE_AUDITOR'] },
  ];
